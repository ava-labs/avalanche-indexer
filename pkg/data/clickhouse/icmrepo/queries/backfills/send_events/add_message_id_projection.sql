-- Manual runbook: add the by_message_id projection to icm_send_events_local.
--
...
ALTER TABLE `<database>`.`icm_send_events_local` ON CLUSTER `<cluster>`
...
-- WHERE table = 'icm_send_events_local' AND command LIKE '%by_message_id%';
