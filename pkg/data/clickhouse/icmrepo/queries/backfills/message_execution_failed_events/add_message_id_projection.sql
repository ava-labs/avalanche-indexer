...
ALTER TABLE `<database>`.`icm_message_execution_failed_events_local` ON CLUSTER `<cluster>`
...
-- WHERE table = 'icm_message_execution_failed_events_local' AND command LIKE '%by_message_id%';
