-- Manual runbook: add the by_message_id projection to the ICM receipt events local table.
--
...
-- <table> (the base table name, default icm_receipts_events, configurable via
-- --icm-receipts-events-table-name; the local table is always <table>_local).
