-- Manual runbook: add the by_message_id projection to the ICM add-fee events local table.
--
...
-- <table> (the base table name, default icm_fee_info_events, configurable via
-- --icm-fee-info-events-table-name; the local table is always <table>_local).
