...
Project-level guidance for Claude Code working in this repo. Treat this as authoritative when it conflicts with general defaults. Mirrors `AGENTS.md` — keep the two in sync when editing either.
